...
static const char *menu_names[MENU_ITEM_COUNT] = {"Play", "Settings", "Charts", "Exit"};

static const uint8_t *menu_icons[MENU_ITEM_COUNT] = {bitmap_menu_play, bitmap_menu_settings, bitmap_menu_charts, bitmap_menu_exit};
