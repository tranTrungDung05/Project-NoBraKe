...
const task_t app_task_table[] = {
	...
	/* NOBRAKE GAME */
	/*************************************************************************/
	{NB_GAME_TRACK_ID			,	TASK_PRI_LEVEL_4	,	nb_game_track_handle},
	{NB_GAME_OBSTACLE_ID		,	TASK_PRI_LEVEL_4	,	nb_game_obstacle_handle},
	{NB_GAME_CAR_ID				,	TASK_PRI_LEVEL_4	,	nb_game_car_handle},
	{NB_GAME_SCREEN_ID			,	TASK_PRI_LEVEL_4	,	scr_nobrake_game_handle},
	/*************************************************************************/
	/* LINK TASK */
	/*************************************************************************/
